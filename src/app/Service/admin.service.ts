...
export class AdminService {
  ...
  deleteUser(user : Login) {
    return this.http.post("api/admin/deleteUser/", user, {responseType : 'text'});
  }

  deleteServiceEngineer(serviceEngineer : ServiceEngineerDetails) {
    return this.http.post("api/admin/deleteServiceEngineer/", serviceEngineer, {responseType : 'text'});
  }
